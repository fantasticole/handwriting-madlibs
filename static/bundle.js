...
/***/ function(module, exports, __webpack_require__) {
	...
	var Madlibs = (function (_React$Component3) {
		_inherits(Madlibs, _React$Component3);
						...
						if (piece.story_type === 'topic') {
							return _react2['default'].createElement(
								...
								_react2['default'].createElement(
									...
									{ className: 'note' },
									'Note: ',
									_react2['default'].createElement('img', { className: 'noRender', src: '../../static/images/characters.png' }),
									' will render as question marks.'
								)
							);
						}
